    ...
    return (
        <div className="property-table-container font-lato">
            <div className="property-table-header px-8">
                <div className='headers-table' style={{ borderRight: 'white solid 2px' }}>
                    <p className='tittle'>Inmuebles</p>
                </div>
                <div className='flex justify-start headers-table' style={{ cursor: 'pointer' }}>
            ...
            <div className='property-table-end flex justify-center items-center'>
                ...
                <button className='flex items-center' onClick={()=>navigation('create-property')}><BsPlusLg style={{marginRight:'1rem'}}/> Publicar</button>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="property-table-item p-8 flex justify-evenly">
            ...
            <div className='property-image-info'>
                ...
                <div className='property-image-info-item flex'>
                    <label >Valor:</label>
                    <p><PriceStyle number={props.price || 0} /></p>
                </div>
            </div>
            <div className='property-image-actions flex px-12'>
                <div className='property-image-action-item'>
                    <RiPencilFill style={{ color: '#1B2B42', fontSize: '2rem', margin: 'auto' }} />
                    <p>Editar</p>
                </div>
                <div className='property-image-action-item'>
                    <FaTrash style={{ color: '#1B2B42', fontSize: '1.5rem', margin: 'auto', marginBottom: '7px' }} />
                    <p>Borrar</p>
                </div>
            </div>
        </div>
