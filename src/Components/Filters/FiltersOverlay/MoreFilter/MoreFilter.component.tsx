    ...
    return (
        <>
            ...
            <div className='more-properties-container'>
                <div className='more-item'>
                    ...
                    <div className='flex justify-between more-item-count'>
                        ...
                        <div className='count-more-filter'>
                            <button onClick={() => (bathroom > 0) ? setBathroom(() => bathroom - 1) : {}}>-</button>
                            <span>{bathroom}</span>
                ...
                <div className='more-item'>
                    <img src={ParkingIcon} alt="" style={{ marginLeft: 5, width: '1rem' }} />
                    <h2 >Parqueaderos</h2>
                    <div className='flex justify-between more-item-count'>
                        <label >Parqueaderos</label>
                        <div className='count-more-filter'>
                            <button onClick={() => (parking > 0) ? setParking(() => parking - 1) : {}}>-</button>
                            <span>{parking}</span>
...
const _mapDispatchToProps = (dispatch: any) => ({
    setFiltersActions: (filterOpen: string) => dispatch(setFilterAction(filterOpen))
})
