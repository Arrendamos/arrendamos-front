    ...
    return (
        <>
            ...
            <div className='flex justify-around my-4 btn-container-filter'>
                <button className='bg-white h-full text-greenCyan text-center hover:bg-slate-300 rounded-lg py-2 px-8 border border-greenCyanHover'
                    style={{ fontSize: '1.3rem' }}
                    onClick={() => props.setFiltersActions('')}>
                    Cancelar
                </button>
                <button className='bg-greenCyan h-full text-white text-center hover:bg-greenCyanHover rounded-lg py-2 px-8' style={{ fontSize: '1.3rem' }}>
                    Seleccionar
                </button>
            </div>
        </>
