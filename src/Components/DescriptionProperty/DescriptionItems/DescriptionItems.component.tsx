...
export function DescriptionItems(): JSX.Element {
    return (
        <div className='description-items'>
            <div className='item-description font-lato'>
                ...
                <div className='mx-6'>
                    ...
                    <p className='value-description'>2</p>
                </div>
            </div>
            <div className='item-description font-lato'>
                <img src={Car} alt="" />
            ...
            <div className='item-description font-lato'>
                ...
                <div className='mx-6'>
                    ...
                    <p className='value-description'>65 m<sup>2</sup></p>
                </div>
            </div>
            <div className='item-description font-lato'>
                ...
                <div className='mx-6'>
                    ...
                    <p className='value-description'>4</p>
                </div>
            </div>
            <div className='item-description font-lato'>
                <img src={Tiempo} alt="" />
                <div className='mx-6'>
                    ...
                    <p className='value-description'>10 Años</p>
                </div>
            </div>
            <div className='item-description font-lato'>
                ...
                <div className='mx-6'>
                    ...
                    <p className='value-description'>$1.780.000</p>
                </div>
            </div>
        </div>
    )
