...
export function PropertyImageFormCommon(): JSX.Element {
    ...
    return (
        <div className="card card-form-property font-lato">
            <h1 className='tittle'>Imágenes de la propiedad</h1>
            <div className="property-image-add">
                <div className='add-image-box cursor-pointer hover:bg-sky-300' onClick={onButtonClick}>
                    <input type='file' id='file' accept="image/png, image/jpeg" ref={inputFile} style={{ display: 'none' }} />
                    <div className='flex items-center justify-center align-middle h-full'>
                        <img className='img-add-bulding' src={Edificio} alt="" style={{ marginRight: '0.8rem' }} />
                ...
                <div className='property-image-add-pending'>
                    ...
                    <div className='add-image-box cursor-pointer hover:bg-sky-300'>
                        <div className='flex items-center justify-center align-middle h-full p-3 '>
                            <h1 style={{ fontSize: '0.9rem', fontWeight: '600' }}>Agregar Fotos</h1>
                            <GrAddCircle style={{ fontSize: '1.8rem', filter: 'brightness(0) invert(1)', marginLeft: '0.2rem' }} />
                        </div>
                    </div>
                </div>
            </div>
